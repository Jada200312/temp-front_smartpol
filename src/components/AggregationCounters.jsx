...
export default function AggregationCounters({ aggregations, onCounterClick }) {
  ...
  const renderGenderLabel = (gender) => {
    ...
    return genderMap[gender] || gender || "No especificado";
  };
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {aggregations.byGender && Array.isArray(aggregations.byGender) && aggregations.byGender.length > 0 && (
        ...
        {aggregations.byLeader && Array.isArray(aggregations.byLeader) && aggregations.byLeader.length > 0 && (
          <div className="border rounded-lg p-4 bg-gradient-to-br from-green-50 to-green-100">
            ...
            <div className="space-y-2 max-h-40 overflow-y-auto">
              {aggregations.byLeader.map((item) => {
                ...
                const leaderName = item.name || item.leaderName || "Sin nombre";
                return (
                  <button
                    key={leaderId}
        ...
        {aggregations.byCandidate && Array.isArray(aggregations.byCandidate) && aggregations.byCandidate.length > 0 && (
          <div className="border rounded-lg p-4 bg-gradient-to-br from-purple-50 to-purple-100">
            ...
            <div className="space-y-2 max-h-40 overflow-y-auto">
              {aggregations.byCandidate.map((item) => {
                ...
                const candidateName = item.name || item.candidateName || "Sin nombre";
                const corporationName = item.corporationName || item.party || "";
                return (
                  <button
                    key={candidateId}
                  ...
                  >
                    <div className="flex flex-col min-w-0 flex-1">
                      <span className="text-xs truncate">{candidateName}</span>
                      {corporationName && (
        ...
        {aggregations.byLocation && Array.isArray(aggregations.byLocation) && aggregations.byLocation.length > 0 && (
          <div className="border rounded-lg p-4 bg-gradient-to-br from-orange-50 to-orange-100">
            ...
            <div className="space-y-2 max-h-40 overflow-y-auto">
              {aggregations.byLocation.map((item) => {
                ...
                const departmentName = item.departmentName || item.name || "Sin departamento";
                const municipalityName = item.municipalityName || "Sin municipio";
                return (
                  <button
