...
export default function CreateAdministradores() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Crear usuario con roleId 2 (Administrador) y organizationId heredado
      ...
      alert.success("El administrador ha sido creado exitosamente", "¡Éxito!");
      ...
      setTimeout(() => {
        navigate("/app/administradores", { state: { refresh: true } });
      }, 2000);
    } catch (err) {
      alert.apiError(err, "Error al crear el administrador");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={() => navigate("/app/administradores")}
          ...
          <div className="border-b pb-6">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="administrador@example.com"
